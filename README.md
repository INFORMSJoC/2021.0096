...
SOS-SDP is an exact algorithm based on the branch-and-bound technique for solving the Minimum Sum-of-Squares Clustering (MSSC) problem. This repository contains the source code used in the paper ["SOS-SDP: an Exact Solver for Minimum Sum-of-Squares Clustering"](https://pubsonline.informs.org/doi/abs/10.1287/ijoc.2022.1166). The instances used in the experiments are available at [UCI Machine Learning](https://archive.ics.uci.edu/ml/index.php) repository.
